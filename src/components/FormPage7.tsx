    ...
    <div className="w-full max-w-full mx-auto p-1 sm:p-2 md:p-3 space-y-1 sm:space-y-2 md:space-y-3">
      <Card className="border-2 border-form-border bg-card p-1 sm:p-2 md:p-3">
              ...
              {index === 1 && (
                <div className="flex items-start gap-4 my-4">
                  <div className="flex-1">
                    <h3 className="font-bold mb-3">{index + 7}. {question.text}</h3>
                    <RadioGroup 
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Label htmlFor="learnerSignature">Learner Signature</Label>
            <Input
              id="learnerSignature"
          ...
          <div>
            <Label htmlFor="assessorFacilitatorSignature">Assessor / Facilitator Signature</Label>
            <Input
