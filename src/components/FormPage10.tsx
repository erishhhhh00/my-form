        ...
        <div className="form-content">
          ...
          <div className="text-center mb-2 sm:mb-4 form-section">
            <div className="flex items-center justify-center mb-2">
              ...
              <div className="text-xl md:text-2xl font-bold">MediHSE</div>
            </div>
                ...
                {index === 3 && (
                  <div className="flex items-start gap-4 my-4">
                    <div className="flex-1">
                      <h3 className="font-bold mb-3">{index + 25}. {question.text}</h3>
                      <RadioGroup 
          ...
          <div className="form-signatures">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <Label htmlFor="learnerSignature" className="text-sm font-semibold mb-2 block">Learner Signature</Label>
                <Input
                  id="learnerSignature"
                  value={pageData.learnerSignature}
                  onChange={(e) => handleInputChange('learnerSignature', e.target.value)}
                  className="mt-1 form-professional-input"
                />
              </div>
              <div>
                <Label htmlFor="assessorFacilitatorSignature" className="text-sm font-semibold mb-2 block">Assessor / Facilitator Signature</Label>
                <Input
