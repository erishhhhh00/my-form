    ...
    <div className="w-full max-w-full mx-auto p-1 sm:p-2 md:p-3 space-y-1 sm:space-y-2">
      <Card className="border-2 border-form-border bg-card p-1 sm:p-2 md:p-3">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            <Label htmlFor="learnerSignature" className="text-xs">Learner Signature</Label>
            <Input
              id="learnerSignature"
          ...
          <div>
            <Label htmlFor="assessorFacilitatorSignature" className="text-xs">Assessor / Facilitator Signature</Label>
            <Input
